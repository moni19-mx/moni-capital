...
export async function callModel({ system, messages, tools, authContext, stream = false, providerOverride, allowFallback = true, maxTokens }) {
  ...
  const args = { system, messages, tools, stream, maxTokens };
  try {
