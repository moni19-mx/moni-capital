...
export async function callOpenAI({ system, messages, tools, model }) {
  ...
  // Los modelos GPT-5.6 no permiten function tools en /v1/chat/completions
  // junto con su modo de razonamiento extendido por defecto -- hay que
  // apagarlo explicitamente para poder usar herramientas aqui. No aplica
  // a gpt-4o (no tiene este parametro).
