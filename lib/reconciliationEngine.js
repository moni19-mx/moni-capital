...
export function valuateAccountEquity({ account_id, asset_id, equity_value, price_usd_per_unit }) {
  if (equity_value == null) {
    return { account_id, asset_id, value_usd: null, status: "DATA_UNAVAILABLE" };
  }
  if (price_usd_per_unit == null) {
    return { account_id, asset_id, value_usd: null, status: "PRICE_UNAVAILABLE" };
  }
  return { account_id, asset_id, value_usd: equity_value * price_usd_per_unit, status: "OK" };
}
